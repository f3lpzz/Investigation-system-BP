...
(async () => {
  ...
  ok(
    ...
    g('(function(){try{var n=0;var OrigImage=window.Image;var pre=_thumbsSalasPre;_thumbsSalasPre=false;window.Image=function(){n++;return {set src(v){}}};try{precarregarThumbsSalas();return n===0;}finally{window.Image=OrigImage;_thumbsSalasPre=pre;}}catch(e){return false;}})()'),
  );
